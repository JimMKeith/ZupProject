...
$query_type  = 'update'; 
$page        = ltrim($_SERVER['PHP_SELF'],'/');  // "manageVids.php"   
$obj_type    = 4;       // videos
$obj         = NULL;
...
require "./code/filterForm.php";       //   A form, accepts parameters to limit the list
$result = listVideos_Manage($pdo, $filter);  //   List vids in a table
